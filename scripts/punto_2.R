...
#Limites
limite_male <- cat(peak_age_male-1.96*se_peak_age_male,peak_age_male+1.96*se_peak_age_male)
limite_female <- cat(peak_age_female-1.96*se_peak_age_female,peak_age_female+1.96*se_peak_age_female)
